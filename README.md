...
<table>
  ...
  <tr>
    ...
    <td width="33%" valign="top">
      <a id="card-en-s03-05"></a>
      <strong>Example: OpenClaw Lobster</strong><br/>
      <img alt="Example: OpenClaw Lobster" title="Create a 16:9 horizontal infographic on a black chalkboard background in colorful chalk style. | Topic: 为什么 OpenClaw 叫龙虾？" src="./images/blog/b5.png" width="100%" />
      <br/>
      <a href="#prompt-en-s03-05">View&CopyPrompt</a>
    </td>
    <td width="33%" valign="top"></td>
  </tr>
</table>
...
<a id="prompt-en-s03-05"></a>
#### Example: OpenClaw Lobster

[Back to image](#card-en-s03-05)
